...
public abstract class MessageOutViewHolderBundle extends ViewHolderBundle<RecyclerView.ViewHolder,Object> {
    @Override
    public int getLayoutResourceId() {
        return R.layout.chat_ai_message_out;
    }
    ...
    public void bind(RecyclerView.ViewHolder viewHolder, Object data) {
        if(viewHolder instanceof MessageOutViewHolder && data instanceof Message){
            MessageOutViewHolder messageViewHolder = (MessageOutViewHolder) viewHolder;
